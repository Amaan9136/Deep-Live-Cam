...
requests, discussions, commit messages) and also applies when an
individual is officially representing the project in public spaces —
for example, using an official project email or social media account.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may
be reported to the project maintainer at
[Amaan9136](https://github.com/Amaan9136) via a GitHub issue (marked
confidential/private where the platform allows) or through the contact
method listed in [SECURITY.md](SECURITY.md). All complaints will be
